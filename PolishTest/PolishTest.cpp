...
TEST(Polish, throw_when_math_expression_have_big_then_nuzhno_skobok)
{
  char s[] = "(9*8";
  TString A(s);
  TQueue<char> B;
...
TEST(Polish, throw_when_math_expression_is_bad_in_begin)
{
  char s[] = "*9*8";
  TString A(s);
  TQueue<char> B;
...
TEST(Polish, no_throw_when_queue)
{
  TQueue<char> B(7);
  B.Put('[');
  B.Put('9');
...
TEST(Polish, throw_when_queue_is_bad_in_begin)
{
  TQueue<char> B(7);
  B.Put('+');
  B.Put('[');
...
TEST(Polish, throw_when_queue_is_bad_in_begin_2)
{
  TQueue<char> B(7);
  B.Put('[');
  B.Put('9');
